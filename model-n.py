...
checkpoint = ModelCheckpoint(filepath='./models/best-n.h5', monitor='val_loss', save_best_only=True, save_weights_only=True,verbose=1)
...
model.load_weights('./models/best-n.h5')

# now save model
model.save('model-n4.h5')
